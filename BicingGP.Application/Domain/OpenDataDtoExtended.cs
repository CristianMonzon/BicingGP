namespace BicingGP.Application.Domain.OpenData
{
    ...
    {
        public static List<MediatR.OpenData.Status.OpenDataStatusOutDto> ToStatusOutDtos(this DataDomain.OpenData.Status.OpenDataRootStatus openDataStatus)
        {            
            return openDataStatus!.data!.stations!.Select(c => c.ToStatusOutDto()).ToList();
        }

        public static MediatR.OpenData.Status.OpenDataStatusOutDto ToStatusOutDto(this DataDomain.OpenData.Status.Station station)
        {
        ...
        public static List<MediatR.OpenData.Station.OpenDataStationOutDto> ToStationOutDtos(this DataDomain.OpenData.Station.Data openData)
        {
            return openData!.stations!.Select(c => c.ToStationOutDto()).ToList();
        }

        private static MediatR.OpenData.Station.OpenDataStationOutDto ToStationOutDto(this DataDomain.OpenData.Station.Station station)
        {
